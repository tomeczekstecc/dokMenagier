...
import rwd from '../../../img/rwd_film.jpg';
...
const CardPdfPreview = ({ body }) => {
  ...
  let iconType = 'far fa-file-video animated flash'
  return (
    <div
      id='card_film_preview'
      style={{
              zIndex: -2,
        fontFamily:
    ...
    >
      ...
      >
        <Meta
          ...
          title={body.title.toUpperCase() || 'TEST'}
